import luigi
from luigitasks.parse_pbp import StatsNBAPlayByPlayTask
...
def sample_game():
    pbp_task = StatsNBAPlayByPlayTask(game_id="0020901030")
    luigi.build([pbp_task], local_scheduler=True)
    game = open(pbp_task.output(), 'r')
    return game
